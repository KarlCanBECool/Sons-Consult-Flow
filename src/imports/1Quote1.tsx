import svgPaths from "./svg-vwlafv4i4l";
...
function Frame() {
  return <div className="bg-[#f7f7f7] h-[4px] rounded-br-[999px] rounded-tr-[999px] shrink-0 w-[58px]" />;
}
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-px relative size-full">
          <div className="font-['Aeroport:Bold',sans-serif] leading-[40px] not-italic relative shrink-0 text-[36px] text-black text-center tracking-[-1.4px] whitespace-nowrap whitespace-pre">
            <p className="mb-0">{`Hair loss affects men of all ages. `}</p>
...
function DoctorCallOut() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f7f7f7] content-stretch flex gap-[12px] items-center left-1/2 p-[8px] rounded-[9999px] top-[622px] w-[228px]" data-name="Doctor-Call-Out">
      <Image />
      <div className="font-['Aeroport:Light',sans-serif] leading-[18px] not-italic relative shrink-0 text-[14px] text-black tracking-[-0.3px] whitespace-nowrap whitespace-pre">
...
export default function Component1Quote() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-px items-start overflow-clip relative rounded-[32px] size-full" data-name="1. Quote 1">
      <div className="bg-[#25272a] h-[100px] relative shrink-0 w-full" data-name="Navigational-Bar">
        <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center px-[64px] py-[25px] relative size-full">
            <Frame1 />
          </div>
        </div>
      </div>
