import svgPaths from "./svg-65jdme9uvy";
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0">
      <div className="font-['Aeroport:Bold',sans-serif] leading-[40px] not-italic relative shrink-0 text-[36px] text-black text-center tracking-[-1.4px] whitespace-nowrap">
        <p className="mb-0">Sons is proven to help men take control and</p>
        <p>give them back their confidence.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-px items-center justify-center p-px relative size-full">
          <Frame14 />
          <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[8px] items-center left-1/2 top-[331px]">
            <Image />
            <p className="font-['Aeroport:Light',sans-serif] leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-center tracking-[-0.3px] whitespace-nowrap">Dr. Knut A. Moe, Sons Medical Director</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-px items-start overflow-clip relative rounded-[32px] size-full" data-name="Desktop - 3">
