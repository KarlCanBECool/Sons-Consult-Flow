import svgPaths from "./svg-zo06osr2kn";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Stop hair loss</p>
      ...
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Regrow hair</p>
        <div className="bg-[#fdfdff] pointer-events-none relative rounded-[8px] shrink-0 size-[28px]" data-name="UI control / Item / Checkbox">
          <div className="absolute inset-0 rounded-[inherit] shadow-[inset_0px_4px_4px_0px_rgba(0,0,0,0.11)]" />
          <div aria-hidden="true" className="absolute border-2 border-[#00b692] border-solid inset-0 rounded-[8px]" />
        </div>
      ...
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Improve hairline</p>
        <div className="bg-[#fdfdff] pointer-events-none relative rounded-[8px] shrink-0 size-[28px]" data-name="UI control / Item / Checkbox">
          <div className="absolute inset-0 rounded-[inherit] shadow-[inset_0px_4px_4px_0px_rgba(0,0,0,0.11)]" />
          <div aria-hidden="true" className="absolute border-2 border-[#00b692] border-solid inset-0 rounded-[8px]" />
        </div>
      ...
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">All of the above</p>
        <div className="bg-[#fdfdff] pointer-events-none relative rounded-[8px] shrink-0 size-[28px]" data-name="UI control / Item / Checkbox">
          <div className="absolute inset-0 rounded-[inherit] shadow-[inset_0px_4px_4px_0px_rgba(0,0,0,0.11)]" />
          <div aria-hidden="true" className="absolute border-2 border-[#00b692] border-solid inset-0 rounded-[8px]" />
        </div>
...
export default function Desktop() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-px items-start overflow-clip relative rounded-[32px] size-full" data-name="Desktop - 20">
