import svgPaths from "./svg-7nrjjzisc3";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <p className="font-['Aeroport:Bold','Noto_Sans:Bold',sans-serif] leading-[34px] relative shrink-0 text-[28px] text-black tracking-[-1.4px] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>
        What treatment type do you prefer?
      </p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Topical sprays - (apply to scalp)</p>
      </div>
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Oral capsule - (take once a day)</p>
      </div>
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">I don’t mind - I want what’s most effective for me</p>
      </div>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-px items-start overflow-clip relative rounded-[32px] size-full" data-name="Desktop - 17">
