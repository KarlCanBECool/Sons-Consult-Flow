import svgPaths from "./svg-cx889jghqp";
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
      <div className="bg-[#f7f7f7] content-stretch flex gap-px h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <div aria-hidden="true" className="absolute border-2 border-[#4300dd] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Gradually over months and years</p>
      </div>
      <div className="bg-[#f7f7f7] content-stretch flex gap-[8px] h-[72px] items-center justify-center px-[24px] relative rounded-[12px] shrink-0 w-[520px]" data-name="Form-Button">
        <p className="flex-[1_0_0] font-['Aeroport:Light',sans-serif] leading-[20px] min-h-px min-w-px not-italic relative text-[16px] text-black tracking-[-0.3px]">Suddenly (it fell out over a matter of days or a few weeks)</p>
      </div>
    </div>
  );
}
...
export default function Desktop() {
  return (
    <div className="bg-[#e6e6e6] content-stretch flex flex-col gap-px items-start overflow-clip relative rounded-[32px] size-full" data-name="Desktop - 12">
