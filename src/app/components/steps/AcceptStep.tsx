    ...
    <div className="flex-1 relative w-full overflow-y-auto">
      <div className="flex flex-col items-center justify-center min-h-full max-md:justify-start max-md:min-h-0">
        <div className="content-stretch flex flex-col gap-[24px] items-center justify-center px-px py-[80px] relative w-full max-md:items-start max-md:justify-start max-md:gap-0 max-md:py-0 max-md:pt-[112px] max-md:pb-[56px]">
          <div className="content-stretch flex gap-[24px] items-stretch md:items-start justify-center min-h-px min-w-px relative max-w-[1034px] max-md:flex-col max-md:gap-0 max-md:w-full">
            ...
            <div className="h-full relative rounded-[32px] shrink-0 w-[559px] max-md:w-full">
              <div className="flex flex-col items-end rounded-[inherit] size-full">
                <div className="content-stretch flex flex-col gap-[16px] items-end px-[40px] py-[32px] relative size-full my-auto max-md:px-[24px] max-md:py-[32px]">
                  <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative w-full mb-[16px]">
                    ...
                    <div className="font-['Aeroport:Light',sans-serif] leading-[0] text-[0px] text-black tracking-[-0.3px] w-full mt-[40px]">
                      ...
                      <p className="md:hidden font-['Aeroport:Light',sans-serif] leading-[20px] text-[16px] text-black tracking-[-0.3px] w-full mt-[16px]">
          ...
          <p className="max-md:hidden font-['Aeroport:Light',sans-serif] leading-[20px] text-[16px] text-black tracking-[-0.3px] w-[1034px]">
            <span>Already have an account? </span>
            <span className="text-[#4300dd] cursor-pointer hover:underline">Log in</span>
          </p>
        </div>
